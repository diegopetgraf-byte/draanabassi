...
import { professional, navigation } from '@/data/config';
            ...
            <div className="relative flex items-center justify-between h-16">
              ...
              <nav className="hidden lg:flex items-center gap-1 mx-auto">
                {navigation.map((item) => (
                  <a
                    ...
                    className={`px-3 py-1.5 text-[11px] font-sans font-semibold uppercase tracking-wider transition-all duration-200 rounded-lg hover:text-logo-gradient ${activeSection === item.href.substring(1)
              ...
              <div className="flex-1 lg:flex-none flex items-center justify-end">
                ...
                >
                  ...
                  <button
                    className="relative z-10 px-4 py-2 md:px-5 md:py-2.5 text-[10px] md:text-xs font-sans font-semibold uppercase tracking-wider text-white bg-logo-gradient rounded-full transition-all hover:-translate-y-0.5 hover:shadow-md cursor-pointer"
          ...
          >
            ...
            <div className="p-6 flex justify-between items-center bg-secondary">
              ...
              <button
                ...
                className="w-[38px] h-[38px] rounded-full flex items-center justify-center bg-background transition-all duration-200 [box-shadow:inset_2px_2px_4px_rgba(255,255,255,0.9),inset_-2px_-2px_4px_rgba(0,0,0,0.05),4px_4px_12px_rgba(0,0,0,0.08),-2px_-2px_8px_rgba(255,255,255,0.8)] active:scale-95 cursor-pointer"
              >
              ...
              {navigation.map((item, idx) => (
                ...
                >
                  <a
                    href={item.href}
                    onClick={(e) => handleNavClick(e, item.href)}
                    className={`block py-2.5 text-xs font-sans font-semibold uppercase tracking-[0.15em] transition-all hover:text-logo-gradient ${activeSection === item.href.substring(1)
              ...
              <div className="flex flex-col items-start gap-4">
                ...
                >
                  ...
                  <div className="flex flex-col items-start">
                    <span className="text-[10px] uppercase tracking-wider text-muted-foreground font-semibold leading-none mb-1">{professional.name}</span>
                    <span className="text-sm font-bold text-foreground group-hover:text-logo-gradient transition-colors leading-none">{professional.phoneDisplay}</span>
                  </div>
                </a>
              </div>
            </div>
